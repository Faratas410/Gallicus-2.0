...
- `legacy runtime (storico/rimosso)` — Legacy runtime artifacts removed from active repository flow.
...
- `legacy runtime (storico/rimosso)` contained old gameplay/pickup scenes/scripts not mapped as active entry flow.
