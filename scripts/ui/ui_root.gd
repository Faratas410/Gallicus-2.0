...
@onready var upgrade_bg: TextureRect = get_node_or_null("Modals/ModalCenter/UpgradePanel/UpgradeBG") as TextureRect
@onready var upgrade_content_area: Control = get_node_or_null("Modals/ModalCenter/UpgradePanel/UpgradeContentArea") as Control
@onready var upgrade_vbox: VBoxContainer = get_node_or_null("Modals/ModalCenter/UpgradePanel/UpgradeContentArea/UpgradeVBox") as VBoxContainer
@onready var upgrade_tokens_label: Label = get_node_or_null("Modals/ModalCenter/UpgradePanel/UpgradeContentArea/UpgradeVBox/UpgradeCoinsLabel") as Label
@onready var upgrade_hp_label: Label = get_node_or_null("Modals/ModalCenter/UpgradePanel/UpgradeContentArea/UpgradeVBox/UpgradeRows/UpgradeHPRow/UpgradeHPRowHBox/UpgradeHPLabel") as Label
@onready var upgrade_light_label: Label = get_node_or_null("Modals/ModalCenter/UpgradePanel/UpgradeContentArea/UpgradeVBox/UpgradeRows/UpgradeLightRow/UpgradeLightRowHBox/UpgradeLightLabel") as Label
@onready var upgrade_heavy_label: Label = get_node_or_null("Modals/ModalCenter/UpgradePanel/UpgradeContentArea/UpgradeVBox/UpgradeRows/UpgradeHeavyRow/UpgradeHeavyRowHBox/UpgradeHeavyLabel") as Label
@onready var upgrade_hp_row: Control = get_node_or_null("Modals/ModalCenter/UpgradePanel/UpgradeContentArea/UpgradeVBox/UpgradeRows/UpgradeHPRow") as Control
@onready var upgrade_light_row: Control = get_node_or_null("Modals/ModalCenter/UpgradePanel/UpgradeContentArea/UpgradeVBox/UpgradeRows/UpgradeLightRow") as Control
@onready var upgrade_heavy_row: Control = get_node_or_null("Modals/ModalCenter/UpgradePanel/UpgradeContentArea/UpgradeVBox/UpgradeRows/UpgradeHeavyRow") as Control
@onready var upgrade_hp_button: Button = get_node_or_null("Modals/ModalCenter/UpgradePanel/UpgradeContentArea/UpgradeVBox/UpgradeRows/UpgradeHPRow/UpgradeHPRowHBox/UpgradeHPButton") as Button
@onready var upgrade_light_button: Button = get_node_or_null("Modals/ModalCenter/UpgradePanel/UpgradeContentArea/UpgradeVBox/UpgradeRows/UpgradeLightRow/UpgradeLightRowHBox/UpgradeLightButton") as Button
@onready var upgrade_heavy_button: Button = get_node_or_null("Modals/ModalCenter/UpgradePanel/UpgradeContentArea/UpgradeVBox/UpgradeRows/UpgradeHeavyRow/UpgradeHeavyRowHBox/UpgradeHeavyButton") as Button
@onready var upgrade_continue_button: Button = get_node_or_null("Modals/ModalCenter/UpgradePanel/UpgradeContentArea/UpgradeVBox/UpgradeContinueButton") as Button
@onready var stake_input: SpinBox = _req("Modals/ModalCenter/BetPanel/BetVBox/StakeRow/StakeInput") as SpinBox
@onready var bet_win_button: Button = _req("Modals/ModalCenter/BetPanel/BetVBox/BetButtons/BetWinButton") as Button
@onready var bet_no_hit_button: Button = _req("Modals/ModalCenter/BetPanel/BetVBox/BetButtons/BetNoHitButton") as Button
@onready var bet_fast_button: Button = _req("Modals/ModalCenter/BetPanel/BetVBox/BetButtons/BetFastButton") as Button
...
@onready var game_over_panel: Panel = get_node_or_null("Modals/ModalCenter/GameOverPanel") as Panel
@onready var game_over_title: Label = get_node_or_null("Modals/ModalCenter/GameOverPanel/GameOverVBox/GameOverTitle") as Label
@onready var game_over_hint: Label = get_node_or_null("Modals/ModalCenter/GameOverPanel/GameOverVBox/GameOverHint") as Label
