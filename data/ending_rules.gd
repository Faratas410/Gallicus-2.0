...
static func dominant_rules() -> Array[Dictionary]:
	return [
		...
		{"id": "PATH_FALL_01", "ending_key": &"THE_FALL", "priority": 108, "requires": {"min_corruption": 5, "min_path_violence": 3}},
		...
		{"id": "PATH_PET_01", "ending_key": &"THE_CROWD_PET", "priority": 90, "requires": {"min_cashout": 1, "max_double": 1}},
		{"id": "PATH_MARKED_01", "ending_key": &"THE_MARKED", "priority": 85, "requires": {"min_condanna": 1, "max_condanna": 1}},
		{"id": "PATH_BROKEN_01", "ending_key": &"THE_BROKEN", "priority": 109, "requires": {"min_condanna": 2, "min_corruption": 5}},
		{"id": "PATH_SURVIVOR_01", "ending_key": &"THE_SURVIVOR", "priority": 70, "requires": {"max_condanna": 0, "max_corruption": 4, "max_glory": 7}},
		{"id": "PATH_PROVOKE_01", "ending_key": &"THE_DEBTOR", "priority": 75, "requires": {"requires_provoke_armed": true, "min_double": 2}},
	]
