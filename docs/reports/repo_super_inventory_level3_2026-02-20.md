...
- `scripts`: ~53 file
- `docs`: ~57 file
- `legacy runtime (storico/rimosso)`: 8 file
...
### 5.1 Namespace legacy runtime (storico/rimosso)
...
3. **Legacy final cut:** rimozione del namespace legacy runtime (storico/rimosso) dopo snapshot archival.
...
- `find [namespace legacy storico/rimosso] -type f | sort`
- `du -sh * .* 2>/dev/null | sort -h`
- `python3 scripts/ci/check_runtime_invariants.py`
- `python3 scripts/ci/check_no_legacy_references.py`
- `rg -n "UI Official|OK GUI|legacy namespace storico/rimosso|res://ui/official" ...`
