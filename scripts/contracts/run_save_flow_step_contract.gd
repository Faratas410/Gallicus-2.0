...
static func normalize_boundary_value(raw_value: StringName, legacy_resolution_phase_seen: bool, has_bet_id: bool) -> StringName:
	...
	elif legacy_resolution_phase_seen:
