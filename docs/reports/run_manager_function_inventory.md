...
| `to_dict` | `func to_dict() -> Dictionary:` | 402 | public | `to_dict`, `_build_run_save_payload`, `_serialize_run_scars` | `UNKNOWN` |
| `to_dict` | `func to_dict() -> Dictionary:` | 417 | public | `to_dict`, `_build_run_save_payload`, `_serialize_run_scars` | `UNKNOWN` |
| `_update_flow_phase` | `func _update_flow_phase(metrics: Dictionary) -> void:` | 457 | private | `record_scar_annotation`, `record_run_end_annotation` | `UNKNOWN` |
...
| `record_run_end_annotation` | `func record_run_end_annotation(reason: String, scar_count: int, metrics: Dictionary) -> Dictionary:` | 525 | public | `_emit_register_annotation_from_run_end` | `UNKNOWN` |
| `to_text` | `func to_text() -> String:` | 563 | public | `_select_run_finale` | `UNKNOWN` |
| `to_dict` | `func to_dict() -> Dictionary:` | 572 | public | `to_dict`, `_build_run_save_payload`, `_serialize_run_scars` | `UNKNOWN` |
| `_ready` | `func _ready() -> void:` | 1189 | private | unknown | `UNKNOWN` |
| `_connect_gameevents` | `func _connect_gameevents() -> void:` | 1200 | private | `_ready` | `UNKNOWN` |
...
| `_on_settings_changed` | `func _on_settings_changed(payload: Dictionary) -> void:` | 1318 | private | unknown | `UNKNOWN` |
...
| `_ensure_flow_panel` | `func _ensure_flow_panel(path: String, context: String) -> bool:` | 1450 | private | `_start_resolve_ritual`, `_enter_mid_choice`, `_enter_push_your_luck` | `UNKNOWN` |
...
| `_start_level3_run` | `func _start_level3_run() -> void:` | 1627 | private | `_start_new_run`, `_on_request_retry_run`, `_on_request_end_run_next_bet` | `UNKNOWN` |
...
| `_start_resolve_ritual` | `func _start_resolve_ritual(bet_id: StringName) -> void:` | 1832 | private | `_start_pact_sealed_ritual` | `UNKNOWN` |
| `_resolve_ritual_outcome` | `func _resolve_ritual_outcome(bet_id: StringName) -> void:` | 1857 | private | `_start_resolve_ritual` | `UNKNOWN` |
...
| `_play_arena_resolution_fx` | `func _play_arena_resolution_fx() -> void:` | 1972 | private | `_resolve_ritual_outcome`, `_enter_resolution` | `UNKNOWN` |
...
| `reset_run` | `func reset_run() -> void:` | 2017 | public | unknown | `UNKNOWN` |
...
| `_weighted_pick_index` | `func _weighted_pick_index(pool: Array[Dictionary]) -> int:` | 2159 | private | `_pick_weighted_bets` | `UNKNOWN` |
| `_get_run_seed_value` | `func _get_run_seed_value() -> int:` | 2177 | private | `_start_level3_run` | `UNKNOWN` |
| `_compute_level3_seed` | `func _compute_level3_seed(bet_id: StringName) -> int:` | 2182 | private | `_resolve_level3_arena` | `UNKNOWN` |
| `_compute_level3_offer_seed` | `func _compute_level3_offer_seed() -> int:` | 2194 | private | `_build_level3_bet_offer` | `UNKNOWN` |
...
| `_emit_escalation_changed` | `func _emit_escalation_changed() -> void:` | 2431 | private | `_start_level3_run`, `_apply_run_save_payload`, `_apply_special_arena_pre_resolution` | `UNKNOWN` |
| `_get_current_arena_index` | `func _get_current_arena_index() -> int:` | 2436 | private | `_pick_next_arena_theme`, `_append_pact_log_entry` | `UNKNOWN` |
| `_get_available_arena_theme_ids` | `func _get_available_arena_theme_ids() -> Array[StringName]:` | 2442 | private | `_pick_next_arena_theme`, `get_available_arena_themes` | `UNKNOWN` |
| `_pick_next_arena_theme` | `func _pick_next_arena_theme() -> StringName:` | 2453 | private | `_emit_arena_theme_changed` | `UNKNOWN` |
| `_emit_arena_theme_changed` | `func _emit_arena_theme_changed() -> void:` | 2459 | private | `start_arena` | `UNKNOWN` |
...
| `_pick_special_arena_index` | `func _pick_special_arena_index(target_arenas: int) -> int:` | 2493 | private | `_start_level3_run`, `_apply_run_save_payload` | `UNKNOWN` |
| `_maybe_activate_special_arena` | `func _maybe_activate_special_arena() -> void:` | 2501 | private | `start_arena` | `UNKNOWN` |
| `_emit_special_arena_started` | `func _emit_special_arena_started() -> void:` | 2522 | private | `_maybe_activate_special_arena` | `UNKNOWN` |
| `_get_special_arena_title` | `func _get_special_arena_title(arena_id: StringName) -> String:` | 2535 | private | `_emit_special_arena_started`, `_build_run_log` | `UNKNOWN` |
| `_get_special_arena_description` | `func _get_special_arena_description(arena_id: StringName) -> String:` | 2548 | private | `_emit_special_arena_started` | `UNKNOWN` |
| `_apply_special_arena_pre_resolution` | `func _apply_special_arena_pre_resolution() -> void:` | 2561 | private | `_resolve_ritual_outcome`, `_enter_resolution` | `UNKNOWN` |
| `_apply_special_arena_post_resolution` | `func _apply_special_arena_post_resolution(result: ArenaResult, failed: bool) -> void:` | 2575 | private | `_resolve_ritual_outcome`, `_enter_resolution` | `UNKNOWN` |
| `_apply_special_arena_ash_reward` | `func _apply_special_arena_ash_reward(result: ArenaResult, failed: bool) -> void:` | 2588 | private | `_apply_special_arena_post_resolution` | `UNKNOWN` |
...
| `_select_enemy_profile` | `func _select_enemy_profile() -> void:` | 2606 | private | `start_arena` | `UNKNOWN` |
| `_weighted_pick_enemy_index` | `func _weighted_pick_enemy_index(pool: Array[Dictionary]) -> int:` | 2626 | private | `_select_enemy_profile` | `UNKNOWN` |
| `_compute_level3_enemy_seed` | `func _compute_level3_enemy_seed() -> int:` | 2644 | private | `_select_enemy_profile` | `UNKNOWN` |
| `_get_enemy_profile_def` | `func _get_enemy_profile_def(profile_id: StringName) -> Dictionary:` | 2651 | private | unknown | `UNKNOWN` |
| `_log_level3_arena_result` | `func _log_level3_arena_result(bet_id: StringName, result: ArenaResult, scars_applied: Array[StringName]) -> void:` | 2658 | private | `_resolve_ritual_outcome`, `_enter_resolution` | `UNKNOWN` |
| `_get_active_scar_ids` | `func _get_active_scar_ids() -> Array[StringName]:` | 2679 | private | `_resolve_level3_arena` | `SCAR_LOGIC` |
| `_resolve_level3_arena` | `func _resolve_level3_arena() -> ArenaResult:` | 2687 | private | `_resolve_ritual_outcome`, `_enter_resolution` | `UNKNOWN` |
...
| `_handle_level3_win` | `func _handle_level3_win(bet_id: StringName, _result: ArenaResult) -> void:` | 2709 | private | `_enter_resolution` | `UNKNOWN` |
| `_handle_level3_loss` | `func _handle_level3_loss(bet_id: StringName, _result: ArenaResult) -> Array[StringName]:` | 2716 | private | `_enter_resolution` | `UNKNOWN` |
| `_handle_level3_loss_ritual` | `func _handle_level3_loss_ritual(bet_id: StringName, _result: ArenaResult) -> Array[StringName]:` | 2761 | private | `_resolve_ritual_outcome` | `UNKNOWN` |
| `_apply_max_hp_loss` | `func _apply_max_hp_loss(amount: int) -> void:` | 2806 | private | `_handle_level3_loss`, `_handle_level3_loss_ritual` | `UNKNOWN` |
| `_apply_level3_reward` | `func _apply_level3_reward(bet_id: StringName, reward_tier: int) -> void:` | 2818 | private | `_resolve_ritual_outcome`, `_take_payout` | `UNKNOWN` |
...
| `_determine_level3_ending_id` | `func _determine_level3_ending_id() -> StringName:` | 2851 | private | unknown | `UNKNOWN` |
| `_ensure_arena_and_player` | `func _ensure_arena_and_player() -> void:` | 2859 | private | `_boot`, `_start_new_run`, `start_arena` | `UNKNOWN` |
| `pick_next_arena_scene` | `func pick_next_arena_scene() -> PackedScene:` | 2907 | public | `load_next_arena` | `UNKNOWN` |
| `_ensure_arena_layout_container` | `func _ensure_arena_layout_container() -> void:` | 2913 | private | `load_next_arena` | `UNKNOWN` |
| `_remove_default_arena_layout` | `func _remove_default_arena_layout() -> void:` | 2932 | private | `load_next_arena` | `UNKNOWN` |
| `load_next_arena` | `func load_next_arena() -> void:` | 2942 | public | `start_arena`, `_on_bet_placed`, `_handle_bet_sealed` | `UNKNOWN` |
| `_reset_or_respawn_player_full` | `func _reset_or_respawn_player_full() -> void:` | 2966 | private | `_start_new_run`, `retry_current_bet` | `UNKNOWN` |
| `_clear_enemies` | `func _clear_enemies() -> void:` | 3001 | private | `_start_new_run`, `start_arena`, `start_next_bet_round` | `UNKNOWN` |
| `_spawn_wave_or_enemies` | `func _spawn_wave_or_enemies() -> void:` | 3006 | private | `start_next_bet_round`, `_push_your_luck` | `LEGACY_SUSPECT` |
| `_ensure_input_map` | `func _ensure_input_map() -> void:` | 3013 | private | `_on_settings_changed` | `UNKNOWN` |
| `_start_next_arena` | `func _start_next_arena() -> void:` | 3049 | private | `_spawn_wave_or_enemies`, `_on_bet_placed`, `_handle_bet_sealed` | `UNKNOWN` |
...
| `_apply_intermediate_choice` | `func _apply_intermediate_choice(choice_id: String) -> void:` | 3205 | private | `request_choose_mid` | `UNKNOWN` |
| `_on_post_arena_choice_selected` | `func _on_post_arena_choice_selected(choice_id: StringName) -> void:` | 3243 | private | unknown | `UNKNOWN` |
| `_on_request_push_luck_cashout` | `func _on_request_push_luck_cashout() -> void:` | 3248 | private | unknown | `FLOW_AUTHORITY` |
| `_take_payout` | `func _take_payout() -> void:` | 3253 | private | `request_take_payout` | `UNKNOWN` |
...
| `_push_your_luck` | `func _push_your_luck() -> void:` | 3335 | private | `request_push_your_luck` | `UNKNOWN` |
...
| `_set_arena_suspended` | `func _set_arena_suspended(suspended: bool) -> void:` | 3473 | private | `_ensure_arena_and_player`, `_apply_modal_lock` | `UNKNOWN` |
...
| `_on_player_spawned` | `func _on_player_spawned(player: Node) -> void:` | 3615 | private | unknown | `UNKNOWN` |
| `_on_enemy_killed` | `func _on_enemy_killed(exp_value: int) -> void:` | 3622 | private | unknown | `UNKNOWN` |
| `_xp_needed_for_next` | `func _xp_needed_for_next(level: int) -> int:` | 3638 | private | `_check_level_up`, `_emit_xp_level_ui` | `UNKNOWN` |
| `_check_level_up` | `func _check_level_up() -> bool:` | 3650 | private | `_on_enemy_killed` | `UNKNOWN` |
| `_emit_xp_level_ui` | `func _emit_xp_level_ui() -> void:` | 3665 | private | `_start_new_run`, `_on_enemy_killed` | `UI_WIRING` |
| `get_level` | `func get_level() -> int:` | 3676 | public | unknown | `UNKNOWN` |
| `get_difficulty_tier` | `func get_difficulty_tier() -> int:` | 3679 | public | `get_difficulty_multiplier`, `_apply_enemy_difficulty_to_arena` | `UNKNOWN` |
| `get_difficulty_multiplier` | `func get_difficulty_multiplier() -> float:` | 3682 | public | `_recompute_difficulty_tier`, `_apply_enemy_difficulty_to_arena` | `UNKNOWN` |
...
| `_recompute_difficulty_tier` | `func _recompute_difficulty_tier(force_emit: bool) -> void:` | 3702 | private | `_on_enemy_killed`, `_reset_progression` | `UNKNOWN` |
| `_apply_enemy_difficulty_to_arena` | `func _apply_enemy_difficulty_to_arena() -> void:` | 3715 | private | `_on_wave_started` | `UNKNOWN` |
| `_resolve_player` | `func _resolve_player() -> Node:` | 3724 | private | `_start_new_run`, `_resolve_ritual_outcome`, `_enter_resolution` | `UNKNOWN` |
| `_connect_player_signals` | `func _connect_player_signals() -> void:` | 3755 | private | `_boot`, `_reset_or_respawn_player_full`, `_on_player_spawned` | `UNKNOWN` |
| `_on_run_failed` | `func _on_run_failed() -> void:` | 3769 | private | unknown | `UNKNOWN` |
| `_on_request_fail_run` | `func _on_request_fail_run(reason: String = "") -> void:` | 3772 | private | `_on_run_failed` | `FLOW_AUTHORITY` |
| `_on_player_died` | `func _on_player_died() -> void:` | 3781 | private | unknown | `UNKNOWN` |
...
| `_reset_intermediate_choice_modifiers` | `func _reset_intermediate_choice_modifiers() -> void:` | 3846 | private | `_push_your_luck`, `_reset_bet_chain`, `_consume_intermediate_choice_bonus` | `UNKNOWN` |
...
| `_apply_intermediate_loss_penalty_if_needed` | `func _apply_intermediate_loss_penalty_if_needed() -> void:` | 3856 | private | `_resolve_ritual_outcome`, `_enter_resolution` | `UNKNOWN` |
...
| `_get_sentence_rule` | `func _get_sentence_rule(bet_id: StringName) -> String:` | 4009 | private | `_build_sentence_payload` | `UNKNOWN` |
| `_get_sentence_doom` | `func _get_sentence_doom(bet_id: StringName) -> String:` | 4021 | private | `_build_sentence_payload` | `UNKNOWN` |
...
| `_get_double_lock_reason` | `func _get_double_lock_reason() -> String:` | 4093 | private | `_push_your_luck`, `_build_push_luck_payload` | `UNKNOWN` |
...
| `_get_level3_doom_short` | `func _get_level3_doom_short(bet_id: StringName) -> String:` | 4277 | private | `_start_resolve_ritual`, `_get_sentence_doom` | `UNKNOWN` |
| `_apply_double_or_die_reward_scaled` | `func _apply_double_or_die_reward_scaled(scale: int) -> void:` | 4293 | private | `_apply_bet_reward_scaled` | `UNKNOWN` |
| `retry_current_bet` | `func retry_current_bet() -> void:` | 4309 | public | `_on_request_retry_run`, `_on_request_end_run_next_bet` | `BET_LOGIC` |
| `_force_game_over_if_dead` | `func _force_game_over_if_dead() -> bool:` | 4324 | private | `start_next_bet_round`, `_open_bet_ui`, `_on_betting_opened` | `UNKNOWN` |
| `_get_player_health_value` | `func _get_player_health_value(p: Node) -> int:` | 4334 | private | `_resolve_ritual_outcome`, `_enter_resolution`, `_push_your_luck` | `UNKNOWN` |
| `_get_player_max_health_value` | `func _get_player_max_health_value(p: Node) -> int:` | 4345 | private | `_resolve_ritual_outcome`, `_enter_resolution`, `_apply_max_hp_loss` | `UNKNOWN` |
...
| `_emit_run_failed` | `func _emit_run_failed() -> void:` | 4412 | private | `_enter_game_over` | `UNKNOWN` |
| `_emit_run_ended` | `func _emit_run_ended() -> void:` | 4420 | private | `_enter_game_over` | `UNKNOWN` |
| `_register_run_end` | `func _register_run_end(reason: String) -> void:` | 4439 | private | `end_run`, `_handle_level3_loss`, `_handle_level3_loss_ritual` | `UNKNOWN` |
| `_emit_run_finale` | `func _emit_run_finale() -> void:` | 4445 | private | `_enter_game_over` | `UNKNOWN` |
| `_should_emit_registry_silence` | `func _should_emit_registry_silence() -> bool:` | 4458 | private | `_emit_run_ended`, `_emit_run_finale` | `UNKNOWN` |
| `_emit_run_log` | `func _emit_run_log(finale: Dictionary) -> void:` | 4470 | private | `_emit_run_finale` | `UNKNOWN` |
| `_build_run_log` | `func _build_run_log(finale: Dictionary) -> String:` | 4476 | private | `_emit_run_log` | `UI_WIRING` |
| `_export_run_summary` | `func _export_run_summary(finale: Dictionary) -> void:` | 4499 | private | `_emit_run_finale` | `UNKNOWN` |
...
| `_select_run_finale` | `func _select_run_finale() -> Dictionary:` | 4543 | private | `_emit_run_ended`, `_emit_run_finale` | `UNKNOWN` |
...
| `get_available_arena_themes` | `func get_available_arena_themes() -> Array[StringName]:` | 4724 | public | unknown | `UNKNOWN` |
| `is_harsh_crowd_unlocked` | `func is_harsh_crowd_unlocked() -> bool:` | 4727 | public | unknown | `UNKNOWN` |
| `get_crowd_line_count_base` | `func get_crowd_line_count_base() -> int:` | 4730 | public | unknown | `UNKNOWN` |
| `get_crowd_line_count_harsh` | `func get_crowd_line_count_harsh() -> int:` | 4733 | public | unknown | `UNKNOWN` |
| `_count_crowd_lines` | `func _count_crowd_lines(source: Dictionary) -> int:` | 4736 | private | `get_crowd_line_count_base`, `get_crowd_line_count_harsh` | `UNKNOWN` |
| `get_arena` | `func get_arena() -> Node:` | 4745 | public | unknown | `UNKNOWN` |
| `get_arena_index` | `func get_arena_index() -> int:` | 4748 | public | unknown | `UNKNOWN` |
| `is_live` | `func is_live() -> bool:` | 4751 | public | unknown | `UNKNOWN` |
| `is_level3_mode` | `func is_level3_mode() -> bool:` | 4754 | public | unknown | `UNKNOWN` |
| `is_visual_only` | `func is_visual_only() -> bool:` | 4757 | public | `_apply_phase`, `_update_arena_visual_only` | `UNKNOWN` |
...
| `set_phase` | `func set_phase(p: Variant) -> void:` | 4825 | public | `request_quit_to_menu`, `_start_new_run`, `_start_level3_run` | `UNKNOWN` |
| `_apply_phase` | `func _apply_phase() -> void:` | 4834 | private | `_on_wave_started`, `_on_player_spawned`, `set_phase` | `UNKNOWN` |
| `_update_arena_visual_only` | `func _update_arena_visual_only() -> void:` | 4839 | private | `_start_new_run`, `_start_level3_run`, `_confirm_pact_with_bet_id` | `UNKNOWN` |
| `_position_player_after_respawn` | `func _position_player_after_respawn() -> void:` | 4850 | private | `_reset_or_respawn_player_full`, `_on_player_spawned` | `UNKNOWN` |
...
| `_reset_progression` | `func _reset_progression() -> void:` | 4880 | private | `_start_new_run` | `UNKNOWN` |
| `_register_condanna` | `func _register_condanna(id: StringName) -> void:` | 4887 | private | `_start_new_run`, `_start_level3_run`, `_confirm_pact_with_bet_id` | `UNKNOWN` |
| `_is_unlocked` | `func _is_unlocked(id: StringName) -> bool:` | 4898 | private | `_is_level3_bet_unlocked`, `_get_available_arena_theme_ids`, `_pick_audience_context_line` | `UNKNOWN` |
...
| `_emit_register_annotation_from_run_end` | `func _emit_register_annotation_from_run_end(reason: String) -> void:` | 4948 | private | `_emit_run_ended` | `UNKNOWN` |
...
| `_get_spawn_position` | `func _get_spawn_position() -> Vector2:` | 5115 | private | `_position_player_after_respawn` | `UNKNOWN` |
| `_find_spawn_node` | `func _find_spawn_node(root: Node) -> Node:` | 5124 | private | `_get_spawn_position` | `UNKNOWN` |
...
## Top optimization candidates (max 20)

1. `to_dict` (L572, ~617 linee, tag `UNKNOWN`)
   - Why: funzione molto estesa
   - Evidence: 617 linee
   - Suggested minimal patch next: Spezzare in helper _enter_* o sotto-funzioni tematiche
2. `_flow_log` (L192, ~210 linee, tag `DEBUG_GUARDS`)
   - Why: funzione molto estesa
   - Evidence: 210 linee
   - Suggested minimal patch next: Spezzare in helper _enter_* o sotto-funzioni tematiche
3. `_connect_gameevents` (L1200, ~108 linee, tag `UNKNOWN`)
   - Why: funzione molto estesa
   - Evidence: 108 linee
   - Suggested minimal patch next: Spezzare in helper _enter_* o sotto-funzioni tematiche
4. `_start_level3_run` (L1627, ~100 linee, tag `UNKNOWN`)
   - Why: funzione molto estesa
   - Evidence: 100 linee
   - Suggested minimal patch next: Spezzare in helper _enter_* o sotto-funzioni tematiche
5. `_start_new_run` (L1532, ~92 linee, tag `FLOW_AUTHORITY`)
   - Why: funzione molto estesa
   - Evidence: 92 linee
   - Suggested minimal patch next: Spezzare in helper _enter_* o sotto-funzioni tematiche
6. `handle_bet_failed` (L3792, ~21 linee, tag `BET_LOGIC`)
   - Why: API pubblica senza chiamanti interni evidenti
   - Evidence: nessun caller interno rilevato automaticamente
   - Suggested minimal patch next: Cercare chiamanti esterni; se assenti, deprecare o rimuovere
7. `_on_wave_cleared` (L3596, ~19 linee, tag `LEGACY_SUSPECT`)
   - Why: dominio legacy/misto nel RunManager
   - Evidence: tag LEGACY_SUSPECT per naming/responsabilità
   - Suggested minimal patch next: Verificare confini con sistemi modulari run/* e preparare estrazione
8. `start_next_bet_round` (L2001, ~16 linee, tag `BET_LOGIC`)
   - Why: API pubblica senza chiamanti interni evidenti
   - Evidence: nessun caller interno rilevato automaticamente
   - Suggested minimal patch next: Cercare chiamanti esterni; se assenti, deprecare o rimuovere
9. `_apply_run_upgrades_to_player` (L5086, ~16 linee, tag `LEGACY_SUSPECT`)
   - Why: dominio legacy/misto nel RunManager
   - Evidence: tag LEGACY_SUSPECT per naming/responsabilità
   - Suggested minimal patch next: Verificare confini con sistemi modulari run/* e preparare estrazione
10. `purchase_token` (L3525, ~11 linee, tag `LEGACY_SUSPECT`)
   - Why: dominio legacy/misto nel RunManager
   - Evidence: tag LEGACY_SUSPECT per naming/responsabilità
   - Suggested minimal patch next: Verificare confini con sistemi modulari run/* e preparare estrazione
11. `get_available_level3_pacts` (L4700, ~11 linee, tag `BET_LOGIC`)
   - Why: API pubblica senza chiamanti interni evidenti
   - Evidence: nessun caller interno rilevato automaticamente
   - Suggested minimal patch next: Cercare chiamanti esterni; se assenti, deprecare o rimuovere
12. `spend_tokens` (L3515, ~10 linee, tag `LEGACY_SUSPECT`)
   - Why: dominio legacy/misto nel RunManager, API pubblica senza chiamanti interni evidenti
   - Evidence: tag LEGACY_SUSPECT per naming/responsabilità, nessun caller interno rilevato automaticamente
   - Suggested minimal patch next: Verificare confini con sistemi modulari run/* e preparare estrazione
13. `restart_run` (L2023, ~9 linee, tag `FLOW_AUTHORITY`)
   - Why: API pubblica senza chiamanti interni evidenti
   - Evidence: nessun caller interno rilevato automaticamente
   - Suggested minimal patch next: Cercare chiamanti esterni; se assenti, deprecare o rimuovere
14. `spend_coins` (L3491, ~9 linee, tag `LEGACY_SUSPECT`)
   - Why: dominio legacy/misto nel RunManager
   - Evidence: tag LEGACY_SUSPECT per naming/responsabilità
   - Suggested minimal patch next: Verificare confini con sistemi modulari run/* e preparare estrazione
15. `consume_upgrade_token` (L3693, ~9 linee, tag `LEGACY_SUSPECT`)
   - Why: dominio legacy/misto nel RunManager, API pubblica senza chiamanti interni evidenti
   - Evidence: tag LEGACY_SUSPECT per naming/responsabilità, nessun caller interno rilevato automaticamente
   - Suggested minimal patch next: Verificare confini con sistemi modulari run/* e preparare estrazione
16. `_on_wave_started` (L3588, ~8 linee, tag `LEGACY_SUSPECT`)
   - Why: dominio legacy/misto nel RunManager
   - Evidence: tag LEGACY_SUSPECT per naming/responsabilità
   - Suggested minimal patch next: Verificare confini con sistemi modulari run/* e preparare estrazione
17. `_soft_reset` (L3784, ~8 linee, tag `LEGACY_SUSPECT`)
   - Why: dominio legacy/misto nel RunManager
   - Evidence: tag LEGACY_SUSPECT per naming/responsabilità
   - Suggested minimal patch next: Verificare confini con sistemi modulari run/* e preparare estrazione
18. `get_level3_pact_title` (L4711, ~8 linee, tag `BET_LOGIC`)
   - Why: API pubblica senza chiamanti interni evidenti
   - Evidence: nessun caller interno rilevato automaticamente
   - Suggested minimal patch next: Cercare chiamanti esterni; se assenti, deprecare o rimuovere
19. `_spawn_wave_or_enemies` (L3006, ~7 linee, tag `LEGACY_SUSPECT`)
   - Why: dominio legacy/misto nel RunManager
   - Evidence: tag LEGACY_SUSPECT per naming/responsabilità
   - Suggested minimal patch next: Verificare confini con sistemi modulari run/* e preparare estrazione
20. `_reset_upgrades` (L4866, ~7 linee, tag `LEGACY_SUSPECT`)
   - Why: dominio legacy/misto nel RunManager
   - Evidence: tag LEGACY_SUSPECT per naming/responsabilità
   - Suggested minimal patch next: Verificare confini con sistemi modulari run/* e preparare estrazione
